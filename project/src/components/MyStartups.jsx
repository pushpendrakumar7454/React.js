        ...
        >
          ...
          <div>
            ...
            <p className="mt-3 max-w-xl text-slate-400 ">
              ...
              Manage every startup you created from one place.
              Edit, delete and monitor your ideas with a modern dashboard.
          ...
          {myStartups.length > 0 ? (
              ...
              >
                ...
                <div className="relative p-7">
                  ...
                  <div className="mt-8 flex flex-wrap gap-4">
                    ...
                    <button
                      className="flex-1 cursor-pointer rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 py-3 font-bold text-white transition hover:scale-105"
                    >
                      👁 View Details
                    </button>

                    <button
                      className="rounded-xl cursor-pointer border border-yellow-400/30 bg-yellow-500/10 px-6 py-3 font-semibold text-yellow-300 transition hover:bg-yellow-500 hover:text-white"
                    >
                      ✏ Edit
                    </button>

                    <button
                      className="rounded-xl cursor-pointer border border-red-400/30 bg-red-500/10 px-6 py-3 font-semibold text-red-400 transition hover:bg-red-500 hover:text-white"
                    >
                      🗑 Delete
                    </button>
            ...
            >
              ...
              <p className="mt-4 max-w-lg text-center leading-8 text-slate-400">
                ...
                Click below and launch your first startup.
