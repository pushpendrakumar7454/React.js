      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
          {stats.map((item) => (
            ...
            >
              <div
                className={`w-14 h-14 rounded-2xl bg-gradient-to-r ${item.color} flex items-center justify-center text-white text-xl shadow-lg group-hover:scale-110 transition`}
              >
                {item.icon}
              </div>
