    ...
    <section className="min-h-screen flex bg-slate-950">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <div className="grid grid-cols-3 gap-5 mt-16">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-3 backdrop-blur-xl">
              <h3 className="text-2xl font-semibold text-white flex justify-center items-center">2K+</h3>

              <p className="text-slate-400 mt-2 flex justify-center items-center">Founders</p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 p-3 backdrop-blur-xl">
              <h3 className="text-2xl font-semibold text-white flex justify-center items-center">10K+</h3>

              <p className="text-slate-400 mt-2 flex justify-center items-center">Developers</p>
            </div>

            <div className="rounded-2xl border border-white/10 bg-white/5 p-3 backdrop-blur-xl">
              <h3 className="text-2xl font-semibold text-white flex justify-center items-center">500+</h3>

              <p className="text-slate-400 mt-2 flex justify-center items-center">Investors</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex justify-center items-center p-6">
        <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-8">
          ...
          <form className="space-y-5 mt-8" onSubmit={handleSubmit(registerForm)}>
            {/* Name */}
            ...
            <label className="flex items-center gap-3 text-sm text-slate-400">
              <input type="checkbox" className="accent-cyan-500" />I agree to
