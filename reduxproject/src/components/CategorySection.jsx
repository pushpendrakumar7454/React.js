    ...
    <section className="relative overflow-hidden py-20 px-6 bg-[#06070d]">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div onClick={()=>navigate("/electronic")} className="cursor-pointer group p-6 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-xl hover:bg-white/[0.08] transition duration-500 hover:-translate-y-2">
