...
const Furniture = () => {
  ...
  const electronicItem = products.filter(
    (item) => item.category === "kitchen-accessories",
  );
            ...
            return (
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-3 bg-black/50 opacity-0 duration-500 group-hover:opacity-100"></div>
                </div>
