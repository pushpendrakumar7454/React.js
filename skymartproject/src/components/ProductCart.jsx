...
const ProductCart = ({ product }) => {
  ...
  return (
    <div className="group relative overflow-hidden cursor-pointer rounded-2xl lg:rounded-[28px] border border-zinc-800 bg-zinc-900 transition-all duration-500 hover:-translate-y-2 hover:border-violet-500/50 hover:shadow-[0_20px_60px_rgba(139,92,246,.25)]">
      {/* Top */}
      <div onClick={() => navigate(`/detail/${product.id}`)} className="relative h-40 sm:h-52 lg:h-60 overflow-hidden bg-gradient-to-br from-zinc-800 via-zinc-900 to-black">
        {/* Category */}
        ...
        <div
          ...
          className="absolute right-2 top-2 lg:right-4 lg:top-4 z-20 flex flex-col gap-2 opacity-100 lg:opacity-0 transition-all duration-300 lg:group-hover:opacity-100"
        >
