...
const ProductCart = ({product}) => {
  return (
    <div className="group relative overflow-hidden rounded-[28px] border border-zinc-800 bg-zinc-900 transition-all duration-500 hover:-translate-y-2 hover:border-violet-500/50 hover:shadow-[0_20px_60px_rgba(139,92,246,.25)]">

      {/* Top */}
      <div className="relative h-[270px] overflow-hidden bg-gradient-to-br from-zinc-800 via-zinc-900 to-black">
      ...
      <div className="space-y-4 p-6">
        ...
        <div>
          ...
          <h2 className="mt-2 text-xl font-bold text-white transition group-hover:text-violet-400">
        ...
        {/* Button */}
        <button className="flex w-full items-center justify-center gap-3 rounded-2xl bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 px-5 py-4 font-semibold text-white transition duration-300 hover:scale-[1.02] hover:shadow-[0_10px_40px_rgba(168,85,247,.45)]">
