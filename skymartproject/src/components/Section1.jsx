...
const Section1 = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#090909] text-white py-14 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
        ...
        <div className="border border-white/10 rounded-[25px] sm:rounded-[30px] lg:rounded-[35px] backdrop-blur-xl bg-white/[0.03] p-6 sm:p-8 md:p-10 lg:p-16">
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <span className="inline-flex items-center gap-2 px-4 sm:px-5 py-2 rounded-full border border-lime-500/30 bg-lime-500/10 text-lime-300 text-xs sm:text-sm font-semibold">
                <Sparkles size={10} />
                GOOD MORNING
              </span>
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 sm:gap-5 mt-8 sm:mt-10">
                ...
                <button className="group flex items-center justify-center gap-3 cursor-pointer active:scale-95 rounded-xl px-6 py-3 bg-lime-400 font-semibold text-black transition hover:scale-105">
                ...
                <button
                  ...
                  className="rounded-xl border border-white/20 active:scale-95 px-6 py-3 cursor-pointer hover:bg-white/10 transition"
                >
                  Explore Products
                </button>
            ...
            <div className="relative flex justify-center mt-6 lg:mt-0">
              ...
              {/* Big Card */}
              <div className="relative w-[240px] h-[240px] sm:w-[270px] sm:h-[270px] md:w-[300px] md:h-[300px] rounded-[28px] sm:rounded-[35px] lg:rounded-[40px] border border-lime-500/20 bg-gradient-to-br from-lime-400/20 to-transparent backdrop-blur-xl flex items-center justify-center">

                <div className="absolute w-56 h-56 sm:w-64 sm:h-64 lg:w-72 lg:h-72 rounded-full bg-lime-400/20 blur-[70px] lg:blur-[90px]"></div>

                <ShoppingBag
                  size={110}
                  className="relative text-lime-400 sm:hidden"
                />
                ...
                <ShoppingBag
                  size={170}
                  className="relative text-lime-400 hidden lg:block"
                />
